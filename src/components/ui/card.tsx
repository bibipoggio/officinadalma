  ...
  "rounded-xl border bg-card text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        ethereal: "bg-sage-light/50 border-sage/20 shadow-soft hover:shadow-card hover:border-sage/30",
        premium: "bg-gradient-to-br from-gold-light to-cream border-gold/20 shadow-glow",
